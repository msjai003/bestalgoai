  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        surfaceBg: "#1A1A1A",  // Secondary Background
        accentPink: "#00BCD4", // Cyan accent
        accentPurple: "#00BCD4", // Also Cyan for consistency
        ...
        charcoalSecondary: "#1A1A1A", // Secondary Background
