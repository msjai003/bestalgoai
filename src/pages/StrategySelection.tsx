...
const StrategySelection = () => {
  ...
  return (
    <div className="bg-charcoalPrimary min-h-screen flex flex-col">
      <Header />
      <TooltipProvider>
        <main className="pt-14 pb-24 flex-1 overflow-hidden">
          <section className="px-4 py-4 h-full flex flex-col">
            <div className="premium-card p-6 mb-6 relative overflow-hidden bg-gradient-to-br from-charcoalSecondary to-charcoalSecondary/80 rounded-xl border border-gray-700/50 shadow-lg hover:shadow-xl hover:border-gray-600/60 transition-all duration-300">
              ...
              <div className="relative z-10">
                ...
                {!hasPremium && (
                  <div className="mt-4 flex items-center gap-2 bg-gradient-to-r from-yellow-900/20 to-yellow-700/10 p-3 pl-3 rounded-lg border border-yellow-700/30">
