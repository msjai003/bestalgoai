        ...
        <section className="mb-6">
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center gap-2">
              ...
              <h2 className="text-xl font-bold text-white">Predefined Strategies</h2>
            </div>
            <Button 
              variant="outline"
              size="sm"
        ...
        <section>
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center gap-2">
              ...
              <h2 className="text-xl font-bold text-white">Custom Strategies</h2>
            </div>
            <Button 
              variant="outline"
              size="sm"
          ...
          <div className="space-y-4">
            {customWishlistedStrategies.length === 0 ? (
              <div className="bg-gray-800/50 rounded-xl p-6 border border-gray-700 flex flex-col items-center justify-center">
                <p className="text-gray-400 mb-4">No custom strategies in your wishlist</p>
                <Button 
                  onClick={() => navigate('/strategy-builder')}
                  variant="outline"
                  className="text-green-500 hover:text-green-400 border-gray-700 bg-transparent hover:bg-gray-800"
