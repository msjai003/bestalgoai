    ...
    <div className="bg-charcoalPrimary min-h-screen">
      ...
      <main className="pt-16 pb-20 px-4">
        <div className="flex items-center justify-between mb-6">
          <h1 className="text-xl font-bold text-charcoalTextPrimary">Live Trading</h1>
          <Button 
            variant="outline" 
            size="sm"
            className="border-charcoalSecondary text-charcoalTextSecondary hover:text-charcoalTextPrimary"
