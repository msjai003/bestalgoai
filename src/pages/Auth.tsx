        ...
        <form onSubmit={handleLogin} className="space-y-6 premium-card p-6 border border-cyan/30 max-w-md mx-auto">
          ...
          <div className="flex justify-center">
            <Button
              ...
              className="px-8 py-2.5 w-3/4 rounded-xl bg-transparent border border-gray-600 hover:bg-gray-800 text-white text-base relative"
            >
              {isGoogleLoading ? (
                <>
