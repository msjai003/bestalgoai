    ...
    <div className="bg-charcoalPrimary/50 border border-gray-700 rounded-lg p-4 mb-6">
      <div className="flex items-start sm:items-center">
        ...
        <div>
          ...
          <p className="text-gray-300 text-sm">All files are locked to protect my work. Click the download button with the lock icon to pay ₹1 and unlock. After payment, you'll be able to download.</p>
