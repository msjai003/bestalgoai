...
export const StrategyFilter = ({
  ...
  return (
    <div className="inline-flex items-center gap-1.5 p-1 bg-charcoalSecondary/30 rounded-[20px] border border-gray-700/50">
      <Button
        variant="outline"
        size="sm"
        onClick={() => onFilterChange("all")}
        className={cn(
          "h-8 px-4 py-0 text-label font-medium rounded-[16px] border-0",
          selectedFilter === "all"
