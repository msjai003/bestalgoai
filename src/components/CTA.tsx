...
export const CTA = () => {
  return (
    <section className="px-4 py-12 bg-gradient-to-t from-gray-900 to-gray-800">
      <div className="text-center">
        ...
        <button className="w-full py-3 px-6 bg-gradient-to-r from-pink-500/80 to-purple-500/80 text-white rounded-xl font-semibold shadow-lg hover:opacity-90 transition-opacity active:scale-[0.98] hover:animate-micro-glow group relative overflow-hidden">
