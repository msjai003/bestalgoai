...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-full text-sm font-medium transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:shrink-0 active:scale-[0.98] duration-200",
  {
    variants: {
      variant: {
      ...
      size: {
        ...
        sm: "h-9 rounded-full px-3 text-xs [&_svg]:size-3.5",
        md: "h-10 rounded-full px-4 [&_svg]:size-4",
        lg: "h-12 rounded-full px-5 text-base [&_svg]:size-5",
        xl: "h-14 rounded-full px-6 text-base [&_svg]:size-5",
