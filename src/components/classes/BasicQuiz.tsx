...
import { fetchBasicQuizQuestions } from '@/adapters/educationAdapter';
...
const BasicQuiz = () => {
  ...
  useEffect(() => {
    const loadQuestions = async () => {
      try {
        setLoading(true);
        const data = await fetchBasicQuizQuestions();
  ...
  return (
    <div className="mt-6">
      <h2 className="text-xl font-bold mb-4">Basic Trading Quiz</h2>
